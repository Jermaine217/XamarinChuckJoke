...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinChuckJoke.Android.dll" comes first in this list. */
		"XamarinChuckJoke.Android.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		...
		"XamarinChuckJoke.dll",
		"ChuckNorrisJokesLibrary.dll",
	};
